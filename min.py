...
class App:
    ...
    def register_new_user(self):
        ...
        self.text_label_register_nes_user = util.get_text_label(self.register_new_user_window,'Please, enter your username')
        self.text_label_register_nes_user.place(x=750, y=70)
